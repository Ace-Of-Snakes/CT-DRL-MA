...
class CurriculumConfig:
    ...
    # Network dimensions (mirrored for convenience, canonical in HierarchicalDQNConfig)
...
class HierarchicalDQNConfig:
    """Network architecture configuration for hierarchical DQN."""

    # Backbone (3D CNN) — 8 channels at split resolution (C, R, S, T)
    in_channels: int = 8
