...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Train terminal agents with GPU acceleration')
...
def main():
    ...
    if args.name is None:
        ...
        args.name = f"gpu_terminal_training_{timestamp}"
