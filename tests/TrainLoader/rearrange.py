...
class TestTrainLoaderRearrange(unittest.TestCase):
    def _make_container(self, cid: str, goods_type: str = "Regular") -> Container:
        now = datetime.now()
        return Container(
            container_id=cid,
            direction="Import",
    ...
    def test_rearrange_reefers_to_ends_and_dg_to_center(self):
        ...
        c_reg0 = self._make_container("REG0", goods_type="Regular")
        c_reef1 = self._make_container("REEF1", goods_type="Reefer")
        c_dg2 = self._make_container("DG2", goods_type="DangerousGoods")
        c_reef4 = self._make_container("REEF4", goods_type="Reefer")
        c_reg5 = self._make_container("REG5", goods_type="Regular")
