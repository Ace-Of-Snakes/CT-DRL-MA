...
from simulation.core.vehicles.truck import (
    Truck,
...
class TestTruckInitialization(unittest.TestCase):
    ...
    def test_default_initialization(self):
        ...
        self.assertTrue(truck.truck_id.startswith("TRK"))
        ...
        self.assertEqual(truck.status, TruckStatus.ARRIVING)
...
class TestTruckOperations(unittest.TestCase):
    ...
    def test_start_loading(self):
        ...
        self.assertEqual(self.truck.status, TruckStatus.LOADING)
    ...
    def test_complete_loading(self):
        ...
        self.assertEqual(self.truck.status, TruckStatus.DEPARTING)
    ...
    def test_depart(self):
        ...
        self.assertEqual(self.truck.status, TruckStatus.DEPARTED)
...
class TestTruckStatus(unittest.TestCase):
    ...
    def test_get_available_length(self):
        ...
        self.assertEqual(self.truck.get_available_length(), STANDARD_VEHICLE_LENGTH_M)

        self.truck.add_container(self.container)
        self.assertAlmostEqual(
            self.truck.get_available_length(),
            STANDARD_VEHICLE_LENGTH_M - 6.0
        )
    ...
    def test_is_full(self):
        ...
        large_container.length = STANDARD_VEHICLE_LENGTH_M - 1.0
