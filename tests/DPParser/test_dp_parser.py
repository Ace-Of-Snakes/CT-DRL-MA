...
class TestDrivingPlanParser(unittest.TestCase):
    ...
    def test_train_id(self):
        """Test train ID generation."""
        id1 = DrivingPlanParser._train_id("TEST", "Op", 0)
        self.assertEqual(id1, "TEST_Op")

        id2 = DrivingPlanParser._train_id("TEST", "Op", 1)
